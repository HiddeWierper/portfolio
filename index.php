...
<head>
  ...
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Rethink+Sans&family=Roboto:wght@300&display=swap"
    rel="stylesheet">
...
<body id="home">
  ...
  <div class="socials">
    ...
    <a href="https://open.spotify.com/user/213ang5atptpcmibq5zug3w4q?si=c9ce2137287e4ebb"
      class="fa-brands fa-spotify"></a>
  </div>
  ...
  <div class="greetings">
    ...
    <input data-target="projects" id="projectsBtn" type="button" value="𝗣𝗿𝗼𝗷𝗲𝗰𝘁𝘀">
  </div>
  ...
  <div class="projects" id="projects">
    ...
    try {
      ...
      foreach ($projects as $project) {
        ...
        echo '<img id="switch' . $projectNameContent . '" onclick="switchImage(\'switch' . $projectNameContent . '\')"  style="' . ($project['id'] % 2 == 0 ? 'transform: scaleX(-1);' : '') . '" src="img/' . $projectImg . '" alt="">';
        echo '</div>';
...
';
  ...
  <section class="contact" id="contact">
    ...
    <form class="contactForm" name="contact" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
      ...
      <span>
        ...
        <input type="tel" name="phone" inputmode="numeric" id="phone" placeholder="+31 123456789"
          onfocus="addValue(this, '+')" onblur="removeValue(this, '+')" required>
      </span>
      <span>
  ...
  <script src="discord/discord.js"></script>
</body>
